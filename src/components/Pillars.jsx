...
/**
 * Pillars — Section wrapper displaying all 5 content pillar cards in a
 * full-width stacked layout (matching The Process section).
 */
function Pillars() {
  return (
    <section id="pillars" className="py-32 px-8">
