# TG Article Inventory
**Source of truth for `src/data/content.js`**
**Last updated:** March 2026

This file contains all published articles with SEO-optimized slugs, excerpts, keywords, and meta descriptions. Claude Code should use this file to populate the `latestContent` array in `content.js`.
...
### Article: The 6 Accounts That Anchor Your Financial Life
**subtitle:** A simple system for where your money should live
**pillar:** finance
**date:** 2026-02-22
...
**excerpt:**
As more money comes in and your future plans become clearer, you'll need a system for where that money lives. Not just one checking account where everything mingles, but a hierarchy of accounts, each with a purpose.

These are the 6 accounts (plus one bonus) that I think everyone should have — an anchor for their finances.

---

### Article: Rich on Any Income
**subtitle:** The one equation that matters
**pillar:** finance
**date:** 2026-02-22
...
**excerpt:**
If there's only one financial equation you memorize, make it this one:
...
### Article: Master Debt or Become Its Slave
**subtitle:** The rules I've followed for 30 years
**pillar:** finance
**date:** 2026-02-22
...
**excerpt:**
Growing up, I always heard there were only two things worth going into debt for: an education and a house.
...
### Article: True Leadership Lifts Others
**subtitle:** The best bosses I ever had didn't act like bosses
**pillar:** career
**date:** 2026-02-22
...
### Article: The Role I Didn't Want Changed Everything
**subtitle:** Sometimes the best opportunities don't look like opportunities
**pillar:** career
**date:** 2026-02-22
...
**excerpt:**
A few years into a role I was comfortable in, my VP decided I wasn't the right fit for the Telco industry segment I'd been assigned to. Within two months, I found myself on a new team, in a new role, focused on a market that most people considered a joke: Public Cloud.
...
### Article: Double Down on What You're Already Good At
**subtitle:** Why I stopped trying to fix my weaknesses
**pillar:** career
**date:** 2026-02-22
...
**excerpt:**
I've always been a sucker for self-improvement books. As a younger man I read As a Man Thinketh, The Greatest Salesman in the World, How to Win Friends and Influence People. The list could get very long if I let it.
...
### Article: The Power of Your Network
**subtitle:** Every major opportunity in my career came from a relationship, not a job posting
**pillar:** career
**date:** 2026-02-22
...
**excerpt:**
Three of the biggest career moves I've ever made came from people I knew.
...
### Article: Don't Try to Be the Smartest Person in the Room
**subtitle:** What MBA swagger and a misplaced phone call taught me about being right vs. being effective
**pillar:** career
**date:** 2026-02-28
...
**excerpt:**
As I packed up my desk and headed home, I already knew the answer to the question forming in my head. How was I going to tell my wife? The harder question was the one I didn't want to sit with: how had I let this happen?
